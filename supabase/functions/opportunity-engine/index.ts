...
const RULES: Record<string, {
  ...
  campaign: { type: 'campaign_optimization', problem: 'A campaign-related signal suggests active go-to-market activity that may benefit from optimization or additional demand generation.', impact: 'Campaign performance can be constrained by weak positioning, creative, targeting, or follow-through.', action: 'Map the campaign signal to a concrete optimization opportunity before outreach.', serviceFamilies: ['Paid Advertising', 'Growth Strategy', 'Content & Social'], base: 76 },
  hiring: { type: 'growth_capacity', problem: 'Hiring activity can indicate expansion, new operating capacity, or a problem the business is actively investing to solve.', impact: 'Growth investments often increase the need for scalable lead generation, content, and automation.', action: 'Determine whether the hiring pattern creates a relevant growth or automation opportunity.', serviceFamilies: ['Growth Strategy', 'AI Automation', 'Lead Generation'], base: 74 },
  expansion: { type: 'market_expansion', problem: 'Expansion activity indicates a potential need for new-market positioning, demand generation, or campaign execution.', impact: 'Expansion can stall when the new market lacks a localized acquisition and conversion motion.', action: 'Prepare a market-entry growth hypothesis tied to the observed expansion.', serviceFamilies: ['Growth Strategy', 'Paid Advertising', 'Content & Social'], base: 82 },
  launch: { type: 'launch_growth', problem: 'A product or offer launch creates a time-sensitive opportunity for positioning, content, paid demand, and conversion support.', impact: 'Launch momentum can be lost without coordinated acquisition and conversion activity.', action: 'Prepare a launch-growth intervention tied directly to the observed launch.', serviceFamilies: ['Growth Strategy', 'Content & Social', 'Paid Advertising'], base: 86 },
  technology_change: { type: 'automation_opportunity', problem: 'A technology-stack change may indicate a workflow, growth, or operational transition that can create automation opportunities.', impact: 'Manual handoffs and disconnected systems can limit the return on new technology investment.', action: 'Investigate the changed workflow and identify a concrete AI/automation improvement.', serviceFamilies: ['AI Automation', 'Growth Operations'], base: 70 },
  leadership_change: { type: 'new_leadership_window', problem: 'A leadership change can create a new decision window for growth priorities, positioning, or operational improvement.', impact: 'New leadership often reassesses growth channels, reporting, and execution systems.', action: 'Build a role-relevant hypothesis from the leadership change and available evidence.', serviceFamilies: ['Growth Strategy', 'AI Automation'], base: 73 },
