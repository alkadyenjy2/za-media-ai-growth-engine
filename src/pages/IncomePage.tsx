...
export function IncomePage() {
  ...
  return <div className="animate-fade-in space-y-6">
    ...
    <div className="grid gap-4 sm:grid-cols-3">
      <div className="card p-5"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent-50 text-accent-600"><CircleDollarSign size={19}/></div><div className="mt-5 text-2xl font-display font-bold">${paid.toLocaleString()}</div><p className="mt-1 text-sm text-neutral-500">Paid revenue</p></div>
      <div className="card p-5"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-warning-50 text-warning-600"><TrendingUp size={19}/></div><div className="mt-5 text-2xl font-display font-bold">${pending.toLocaleString()}</div><p className="mt-1 text-sm text-neutral-500">Pending revenue</p></div>
      <div className="card p-5"><div className="mt-1 text-3xl font-display font-bold">{records.length}</div><p className="mt-1 text-sm text-neutral-500">Total records</p></div>
    </div>
