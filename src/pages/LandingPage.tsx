...
const services = [
  { icon: Search, title: 'Marketing Strategy & Planning', desc: 'Start with market research, competitor analysis, positioning, and a practical marketing plan.' },
  ...
  return <div className="min-h-screen bg-neutral-950 text-white">
    ...
    <section className="relative overflow-hidden pt-32 pb-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-8">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row"><button onClick={() => setShowForm(true)} className="btn-primary text-base">Start your marketing plan <ArrowRight size={18}/></button><button onClick={onEnterDashboard} className="btn bg-white/10 text-white hover:bg-white/20 text-base">View dashboard</button></div>
      </div>
    </section>
    ...
    <section className="border-t border-white/10 bg-gradient-to-b from-neutral-900 to-neutral-950 py-20"><div className="mx-auto max-w-3xl px-4 text-center sm:px-8"><h2 className="font-display text-3xl font-bold sm:text-4xl">Ready to plan your growth?</h2><p className="mt-3 text-neutral-400">Start with a marketing strategy and planning request. We will turn the priorities into an actionable growth roadmap.</p><button onClick={() => setShowForm(true)} className="btn-primary mt-8 text-base">Start your marketing plan <ArrowRight size={18}/></button></div></section>

    <footer className="border-t border-white/10 py-8"><div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-8"><div className="flex items-center gap-3"><img src="/brand/za-media.svg" alt="ZA Media" className="h-8 w-8 rounded-lg"/><div><span className="block font-display font-bold">ZA Media</span><span className="block text-[10px] uppercase tracking-[0.16em] text-neutral-500">Growth Intelligence</span></div></div><p className="text-sm text-neutral-500">AI Growth Engine — Built for revenue.</p></div></footer>
