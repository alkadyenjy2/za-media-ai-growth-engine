export type LeadSource = 'Web Form' | 'LinkedIn Automation' | 'Inbound WhatsApp' | 'Cold Outreach' | 'Meta Ad'
...
export interface ProspectEvidence { id: string; prospect_id: string; evidence_type: ProspectEvidenceType; source_type: ProspectSourceType; source_name: string; source_url: string | null; claim: string; evidence_data: Record<string, unknown>; confidence: number | null; evidence_key: string | null; evidence_status: ProspectEvidenceStatus; extractor: string | null; severity: ProspectEvidenceSeverity | null; impact: string | null; content_hash: string | null; http_status: number | null; mime_type: string | null; observed_at: string; expires_at: string | null; created_at: string }
...
export interface ProspectIntentSignal { id: string; prospect_id: string; signal_type: ProspectIntentSignalType; strength: number; evidence_id: string | null; signal_data: Record<string, unknown>; detected_at: string; expires_at: string | null; created_at: string }
export interface ProspectOpportunity { id: string; prospect_id: string; opportunity_type: string; problem: string; business_impact: string | null; evidence_id: string | null; opportunity_score: number | null; status: 'identified' | 'reviewed' | 'approved' | 'rejected' | 'active' | 'won' | 'lost' | 'expired'; opportunity_data: Record<string, unknown>; created_at: string; updated_at: string }
